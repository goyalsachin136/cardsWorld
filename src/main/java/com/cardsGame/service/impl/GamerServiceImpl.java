...
import com.cardsGame.enums.GameType;
...
import com.cardsGame.repository.GameRepository;
import com.cardsGame.service.CardSetService;
...
public class GamerServiceImpl implements GamerService {
    ...
    public String createGame(int numberOfPlayers, int numberOfCards) {
        ...
        Game game = gameRepository.save(Game.builder()
                .code(CommonUtil.getSmallCapRandomString((short)3))
